...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addConstraint("sumber_daya", {
      fields: ["branch_id", "year", "month"],
      type: "unique",
      name: "unique_sumber_daya_periode"
    });
  },

  async down(queryInterface, Sequelize) {
    // await queryInterface.removeConstraint("pendapatan", "unique_pendapatan_periode");
    await queryInterface.removeConstraint("sumber_daya", "unique_sumber_daya_periode");
  }
};
